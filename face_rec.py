...
hostname = 'redis-16659.c326.us-east-1-3.ec2.redns.redis-cloud.com'
portnumber= 16659
password = 'uPqEiIIPWuorktgesLmwZKDfTbw0vxjs'
...
def retrive_data(name):
    ...
    retrive_df.columns = ['name_role', 'face']
    retrive_df[['name', 'Role']] = retrive_df['name_role'].apply(lambda x: x.split('@')).apply(pd.Series)
    return retrive_df[['name','Role','face']]
...
class RealTimePred:
    ...
    def face_prediction(self,test_image, dataframe, feature_column, test_vector,
        ...
        #step-2: use for Loop and extract each embedding and pass to ml search_algorithm
        for res in results:
